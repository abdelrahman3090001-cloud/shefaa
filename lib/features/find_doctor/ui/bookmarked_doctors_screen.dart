...
class BookmarkedDoctorsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            // Header مطابق للصورة (أخضر غامق، سهم رجوع، عنوان، أيقونة بوكمارك)
            Container(
              height: 110.h,
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    AppColors.deepGreen, // اللون اللي هينتهي تحت
                    AppColors.mainGreen, // اللون اللي هيبدأ من فوق
                  ],
                  begin: Alignment.topCenter,    // البداية من أعلى المنتصف
                  end: Alignment.bottomCenter,   // النهاية في أسفل المنتصف
                ),
              ),
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Icon(Icons.bookmark, color: Colors.white, size: 28.r),
                  ],
                ),
              ),
            ),
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Icon(Icons.bookmark, color: AppColors.mainGreen, size: 24.r),
                                              ],
                                            ),
                                            SizedBox(height: 4.h),
                                            Text(
